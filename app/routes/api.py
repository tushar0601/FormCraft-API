...
from app.routes.block_analytics import router as block_analytics_router
...
router.include_router(
    form_analytics_router, prefix="/form-analytics", tags=["Form-Analytics"]
)
router.include_router(
    block_analytics_router, prefix="/block-analytics", tags=["Block-Analytics"]
)
